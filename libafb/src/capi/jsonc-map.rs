...
extern "C" {
    pub fn json_object_array_insert_idx(
        obj: *mut json_object,
        idx: usize,
        val: *mut json_object,
    ) -> ::std::os::raw::c_int;
...
pub const json_tokener_error_json_tokener_error_memory: json_tokener_error = 15;
pub const json_tokener_error_json_tokener_error_size: json_tokener_error = 16;
